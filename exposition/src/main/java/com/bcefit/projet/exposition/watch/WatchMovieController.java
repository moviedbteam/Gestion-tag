...
public class WatchMovieController {
    ...
    @DeleteMapping(value ="/watch/movie/{uid}")
    public ResponseEntity<String> deleteWatchMovie(@PathVariable UUID uid)  {
